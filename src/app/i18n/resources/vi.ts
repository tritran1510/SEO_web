  ...
  translation: {
    common: {
      ...
      language: {
        ...
        english: "English",
        vietnameseFlagAlt: "Cờ Việt Nam",
        englishFlagAlt: "Cờ Mỹ",
      },
    },
    seoReview: {
      hero: {
      ...
      richText: {
        ...
        openMediaManagerAria: "Mở trình quản lý media",
        toolbarAriaLabel: "Thanh công cụ định dạng rich text",
        addMedia: "Thêm Media",
        font: "Font",
        size: "Size",
        quote: "Trích dẫn",
        listOff: "Tắt danh sách",
        link: "Liên kết",
        table: "Bảng",
        mediaManagerTitle: "Trình quản lý media",
        uploadMedia: "Tải media lên",
        selectImageHint: "Chọn một ảnh để chèn vào nội dung bài viết.",
      },
      history: {
